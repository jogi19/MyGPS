...
public class MainActivity extends AppCompatActivity implements LocationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textview = (TextView) findViewById(R.id.tv_listener_events);
        tvLatitude = (TextView) findViewById(R.id.tvLatitude);
        tvLongitude = (TextView) findViewById(R.id.tvLongitude);
        tvAltitude = (TextView) findViewById(R.id.tvAltitude);
        tvSpeed = (TextView) findViewById(R.id.tvSpeed);
        tvBearing = (TextView) findViewById(R.id.tvBearing);
        tvBearingTo = (TextView) findViewById(R.id.tvBearingTo);
        tvDistanceTo = (TextView) findViewById(R.id.tvDistaceTo);

        et_longitude = (EditText) findViewById(R.id.et_longitute);
